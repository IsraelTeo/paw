...
@NamedStoredProcedureQuery(
        name = "VeterinaryAppointment.insertVeterinaryAppointment",
        ...
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_register_date", type = java.sql.Timestamp.class),
